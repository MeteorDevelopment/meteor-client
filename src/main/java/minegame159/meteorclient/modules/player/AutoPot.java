...
public class AutoPot extends Module {
    ...
    private final Setting<Mode> whatToDrink = sgGeneral.add(new EnumSetting.Builder<Mode>()
            .name("What-To-Drink")
            .description("Determines What potion you drink.")
            .defaultValue(Mode.Healing)
            .build()
    );
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (whatToDrink.get() == Mode.Strength) {
