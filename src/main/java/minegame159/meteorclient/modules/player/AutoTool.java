...
public class AutoTool extends ToggleModule {
    ...
    public boolean isEffectiveOn(Item item, Block block) {
        ...
        if (item instanceof AxeItem && (block == Blocks.SCAFFOLDING || material == Material.WOOD || material == Material.BAMBOO || material == Material.BAMBOO_SAPLING || material == Material.PLANT))  return true;
        ...
        if (item instanceof ShovelItem && (block == Blocks.GRASS_BLOCK || block == Blocks.MYCELIUM || material == Material.SNOW_BLOCK)) return true;
