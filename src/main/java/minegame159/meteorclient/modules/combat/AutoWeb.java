...
public class AutoWeb extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (target != null) {
            ...
            BlockUtils.place(targetPos, Hand.MAIN_HAND, slot, rotate.get(), 0, true);

            if (doubles.get()) {
                targetPos = targetPos.add(0, 1, 0);
                BlockUtils.place(targetPos, Hand.MAIN_HAND, InvUtils.findItemInHotbar(Items.COBWEB), rotate.get(), 0, true);
            }
        }
    }
}