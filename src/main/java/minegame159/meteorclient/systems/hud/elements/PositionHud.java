...
public class PositionHud extends HudElement {
    ...
    public PositionHud() {
        super("coords", "Displays your coordinates in the world.");
    }
    ...
    public void render(HudRenderer renderer) {
        ...
        double xOffset = getAlignmentOffset(left1Width + renderer.textWidth(right1));
