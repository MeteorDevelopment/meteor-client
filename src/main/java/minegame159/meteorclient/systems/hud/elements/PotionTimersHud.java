...
@ElementRegister(name = "potion-timers")
public class PotionTimersHud extends HudElement {
    private final Color color = new Color();

    public PotionTimersHud() {
        super("potion-timers", "Displays active potion effects with timers.");
    }
    ...
    public void render(HudRenderer renderer) {
        ...
        for (StatusEffectInstance statusEffectInstance : mc.player.getStatusEffects()) {
            ...
            renderer.text(text, x + getAlignmentOffset(renderer.textWidth(text)), y, color);
