...
@ElementRegister(name = "active-modules")
public class ActiveModulesHud extends HudElement {
    ...
    private final Setting<Boolean> extraInfo = sgGeneral.add(new BoolSetting.Builder()
    ...
    public ActiveModulesHud() {
        super("active-modules", "Displays your active modules.");
    }

    @Override
    public void update(HudRenderer renderer) {
        if (Modules.get() == null || Modules.get().getActive().isEmpty()) {
        ...
        modules.sort((o1, o2) -> {
            ...
            if (box.boxAnchorY == AnchorY.Bottom) {
                double temp = _1;
                _1 = _2;
                _2 = temp;
            }
    ...
    public void render(HudRenderer renderer) {
        ...
        rainbowHue1 += RainbowColors.GLOBAL.getSpeed() * renderer.delta;
        ...
        for (Module module : modules) {
            renderModule(renderer, module, x + getAlignmentOffset(getModuleWidth(renderer, module)), y);
