...
public class PacketUtils {
    ...
    static {
        ...
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.play.OpenContainerS2CPacket.class, "OpenContainerS2CPacket");
        ...
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.play.OpenHorseContainerS2CPacket.class, "OpenHorseContainerS2CPacket");
        ...
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.play.ContainerSlotUpdateS2CPacket.class, "ContainerSlotUpdateS2CPacket");
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.play.ContainerPropertyUpdateS2CPacket.class, "ContainerPropertyUpdateS2CPacket");
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.play.InventoryS2CPacket.class, "InventoryS2CPacket");
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.play.CloseContainerS2CPacket.class, "CloseContainerS2CPacket");
        ...
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.play.BlockActionS2CPacket.class, "BlockActionS2CPacket");
        ...
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.play.EntitySpawnGlobalS2CPacket.class, "EntitySpawnGlobalS2CPacket");
        ...
        S2C_PACKETS_R.put("OpenContainerS2CPacket", net.minecraft.network.packet.s2c.play.OpenContainerS2CPacket.class);
        ...
        S2C_PACKETS_R.put("OpenHorseContainerS2CPacket", net.minecraft.network.packet.s2c.play.OpenHorseContainerS2CPacket.class);
        ...
        S2C_PACKETS_R.put("ContainerSlotUpdateS2CPacket", net.minecraft.network.packet.s2c.play.ContainerSlotUpdateS2CPacket.class);
        S2C_PACKETS_R.put("ContainerPropertyUpdateS2CPacket", net.minecraft.network.packet.s2c.play.ContainerPropertyUpdateS2CPacket.class);
        S2C_PACKETS_R.put("InventoryS2CPacket", net.minecraft.network.packet.s2c.play.InventoryS2CPacket.class);
        S2C_PACKETS_R.put("CloseContainerS2CPacket", net.minecraft.network.packet.s2c.play.CloseContainerS2CPacket.class);
        ...
        S2C_PACKETS_R.put("BlockActionS2CPacket", net.minecraft.network.packet.s2c.play.BlockActionS2CPacket.class);
        ...
        S2C_PACKETS_R.put("EntitySpawnGlobalS2CPacket", net.minecraft.network.packet.s2c.play.EntitySpawnGlobalS2CPacket.class);
