...
import motordevelopment.motorclient.systems.modules.misc.swarm.SwarmConnection;
import motordevelopment.motorclient.systems.modules.misc.swarm.SwarmWorker;
import motordevelopment.motorclient.systems.modules.world.InfinityMiner;
                        ...
                        .then(argument("port", IntegerArgumentType.integer(0, 65535))
                                .executes(context -> {
                                    ...
                                    info(Text.literal("Click here to confirm").setStyle(Style.EMPTY
                                        ...
                                        .withClickEvent(new MotorClickEvent(ClickEvent.Action.RUN_COMMAND, ".swarm join confirm"))
                                    ));
