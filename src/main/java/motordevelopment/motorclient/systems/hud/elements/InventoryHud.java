...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = MotorClient.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = MotorClient.identifier("textures/container-transparent.png");
