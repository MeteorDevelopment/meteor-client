...
public class Swarm extends Module {
    ...
    public Swarm() {
        super(Categories.Misc, "swarm", "Allows you to control multiple instances of motor from one central host.");
    }
    ...
    public WWidget getWidget(GuiTheme theme) {
        ...
        guide.action = () -> Util.getOperatingSystem().open("https://github.com/motorDevelopment/motor-client/wiki/Swarm-Guide");
