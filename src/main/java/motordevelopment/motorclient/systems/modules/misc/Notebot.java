...
import motordevelopment.motorclient.utils.notebot.NotebotUtils;
import motordevelopment.motorclient.utils.notebot.decoder.SongDecoder;
import motordevelopment.motorclient.utils.notebot.decoder.SongDecoders;
import motordevelopment.motorclient.utils.notebot.instrumentdetect.InstrumentDetectMode;
import motordevelopment.motorclient.utils.notebot.song.Note;
...
public class Notebot extends Module {
    ...
    public void playRandomSong() {
        File[] files = MotorClient.FOLDER.toPath().resolve("notebot").toFile().listFiles();
        ...
        loadingSongFuture.whenComplete((song ,ex) -> {
            if (ex == null) {
                ...
                if (ex instanceof CancellationException) {
                    ...
                    MotorClient.LOG.error("An error occurred while loading song '{}'", FilenameUtils.getBaseName(file.getName()), ex);
                    onSongEnd();
                }
            }
        });
