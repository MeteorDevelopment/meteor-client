...
import motordevelopment.motorclient.mixin.CreativeInventoryScreenAccessor;
...
public class GUIMove extends Module {
    ...
    private void set(KeyBinding bind, boolean pressed) {
        ...
        if (wasPressed != pressed && key.getCategory() == InputUtil.Type.KEYSYM) {
            MotorClient.EVENT_BUS.post(KeyEvent.get(key.getCode(), 0, pressed ? KeyAction.Press : KeyAction.Release));
        }
    }
