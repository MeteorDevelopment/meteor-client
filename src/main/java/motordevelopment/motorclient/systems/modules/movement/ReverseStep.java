...
public class ReverseStep extends Module {
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (!isOnBed() && !mc.world.isSpaceEmpty(mc.player.getBoundingBox().offset(0.0, (float) -(fallDistance.get() + 0.01), 0.0))) ((IVec3d) mc.player.getVelocity()).motor$setY(-fallSpeed.get());
    }
