...
import motordevelopment.motorclient.mixin.ShulkerBoxScreenHandlerAccessor;
...
import motordevelopment.motorclient.systems.modules.combat.KillAura;
...
import motordevelopment.motorclient.utils.misc.HorizontalDirection;
import motordevelopment.motorclient.utils.misc.MBlockPos;
import motordevelopment.motorclient.utils.player.*;
...
import motordevelopment.motorclient.utils.world.Dir;
...
public class HighwayBuilder extends Module {
    ...
    private enum State {
        ...
        Forward {
            ...
            private boolean isCrystalTrap(HighwayBuilder b) {
                for (Entity entity : b.mc.world.getEntities()) {
                    ...
                    ((IVec3d) vec1).motor$set(b.mc.player.getX(), b.mc.player.getY() + b.mc.player.getStandingEyeHeight(), b.mc.player.getZ());
                    ((IVec3d) vec2).motor$set(entity.getX(), entity.getY() + 0.5, entity.getZ());
                ...
                switch (blockState.getBlock()) {
                    ...
                    case ShulkerBoxBlock ignored -> {
                        if (b.mc.currentScreen instanceof ShulkerBoxScreen screen) {
                            ...
                            Inventory inv = ((ShulkerBoxScreenHandlerAccessor) screen.getScreenHandler()).motor$getInventory();
        ...
        DefuseCrystalTraps {
             ...
             *
             * @see motordevelopment.motorclient.mixin.MinecraftClientMixin#wrapStopUsing(ClientPlayerInteractionManager, PlayerEntity)
             */
            @Override
            protected void tick(HighwayBuilder b) {
                if (cooldown > 0) {
