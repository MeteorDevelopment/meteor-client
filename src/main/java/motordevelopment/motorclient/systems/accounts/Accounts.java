...
import motordevelopment.motorclient.systems.accounts.types.CrackedAccount;
...
public class Accounts extends System<Accounts> implements Iterable<Account<?>> {
    ...
    public Accounts fromTag(NbtCompound tag) {
        MotorExecutor.execute(() -> accounts = NbtUtils.listFromTag(tag.getList("accounts", 10), tag1 -> {
