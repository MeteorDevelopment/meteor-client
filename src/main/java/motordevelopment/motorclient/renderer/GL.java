...
import motordevelopment.motorclient.mixin.BufferRendererAccessor;
import motordevelopment.motorclient.mixininterface.ICapabilityTracker;
...
public class GL {
    ...
    public static void saveState() {
        depthSaved = DEPTH.motor$get();
        blendSaved = BLEND.motor$get();
        cullSaved = CULL.motor$get();
        scissorSaved = SCISSOR.motor$get();
    }

    public static void restoreState() {
        DEPTH.motor$set(depthSaved);
        BLEND.motor$set(blendSaved);
        CULL.motor$set(cullSaved);
        SCISSOR.motor$set(scissorSaved);
