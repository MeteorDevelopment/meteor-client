...
public class PacketUtilsUtil {
    ...
    private static class PacketRegistry extends SimpleRegistry<Class<? extends Packet<?>>> {
        public PacketRegistry() {
            super(RegistryKey.ofRegistry(MotorClient.identifier("packets")), Lifecycle.stable());
        }
...
""";
    ...
    public static void init() throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
            writer.write("/*\n");
            writer.write(" * This file is part of the motor Client distribution (https://github.com/motorDevelopment/motor-client/).\n");
            writer.write(" * Copyright (c) motor Development.\n");
            writer.write(" */\n\n");

            writer.write("package motordevelopment.motorclient.utils.network;\n\n");
            ...
            writer.write("import motordevelopment.motorclient.MotorClient;\n");
