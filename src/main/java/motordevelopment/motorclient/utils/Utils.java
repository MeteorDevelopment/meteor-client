...
package motordevelopment.motorclient.utils;
...
import motordevelopment.motorclient.mixin.*;
import motordevelopment.motorclient.mixininterface.IMinecraftClient;
import motordevelopment.motorclient.settings.StatusEffectAmplifierMapSetting;
...
import motordevelopment.motorclient.utils.player.EChestMemory;
import motordevelopment.motorclient.utils.render.PeekScreen;
import motordevelopment.motorclient.utils.render.color.Color;
import motordevelopment.motorclient.utils.world.BlockEntityIterator;
import motordevelopment.motorclient.utils.world.ChunkIterator;
...
public class Utils {
    ...
    public static void init() {
        MotorClient.EVENT_BUS.subscribe(Utils.class);
    }
    ...
    public static byte[] readBytes(InputStream in) {
        try {
            ...
            MotorClient.LOG.error("Error reading from stream.", e);
            return new byte[0];
        } finally {
    ...
    public static void rightClick() {
        ((IMinecraftClient) mc).motor$rightClick();
    }
