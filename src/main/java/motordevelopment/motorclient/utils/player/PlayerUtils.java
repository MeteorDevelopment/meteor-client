...
import motordevelopment.motorclient.systems.modules.movement.NoFall;
...
import motordevelopment.motorclient.utils.misc.text.TextUtils;
...
import static motordevelopment.motorclient.utils.Utils.WHITE;
...
public class PlayerUtils {
    ...
    public static Vec3d getHorizontalVelocity(double bps) {
        ...
        ((IVec3d) horizontalVelocity).motor$setXZ(velX, velZ);
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3d) vec1).motor$set(mc.player.getX(), mc.player.getY() + mc.player.getStandingEyeHeight(), mc.player.getZ());
        ((IVec3d) vec2).motor$set(entity.getX(), entity.getY(), entity.getZ());
        ...
        ((IVec3d) vec2).motor$set(entity.getX(), entity.getY() + entity.getStandingEyeHeight(), entity.getZ());
