...
import motordevelopment.motorclient.mixin.CrossbowItemAccessor;
import motordevelopment.motorclient.mixin.ProjectileInGroundAccessor;
import motordevelopment.motorclient.mixininterface.IVec3d;
import motordevelopment.motorclient.utils.Utils;
import motordevelopment.motorclient.utils.misc.MissHitResult;
...
public class ProjectileEntitySimulator {
    ...
    public HitResult tick() {
        // Apply velocity
        ((IVec3d) prevPos3d).motor$set(pos);
        pos.add(velocity);
    ...
    private HitResult getCollision() {
        ...
        if (hitResult.getType() != HitResult.Type.MISS) {
            ((IVec3d) pos3d).motor$set(hitResult.getPos().x, hitResult.getPos().y, hitResult.getPos().z);
        }
