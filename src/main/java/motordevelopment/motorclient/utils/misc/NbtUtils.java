...
import motordevelopment.motorclient.utils.render.prompts.OkPrompt;
...
public class NbtUtils {
    ...
    public static boolean toClipboard(String name, NbtCompound nbtCompound) {
        ...
        try {
            ...
            MotorClient.LOG.error("Error copying {} NBT to clipboard!", name);
    ...
    public static NbtCompound fromClipboard(NbtCompound schema) {
        try {
            ...
            MotorClient.LOG.error("Invalid NBT data pasted!");
