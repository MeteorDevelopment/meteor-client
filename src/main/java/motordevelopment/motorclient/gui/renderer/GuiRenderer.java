...
import motordevelopment.motorclient.gui.renderer.operations.TextOperation;
import motordevelopment.motorclient.gui.renderer.packer.GuiTexture;
import motordevelopment.motorclient.gui.renderer.packer.TexturePacker;
...
import motordevelopment.motorclient.utils.misc.Pool;
import motordevelopment.motorclient.utils.render.ByteTexture;
...
import static motordevelopment.motorclient.utils.Utils.getWindowHeight;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(MotorClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(MotorClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(MotorClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(MotorClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(MotorClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(MotorClient.identifier("textures/icons/gui/favorite_yes.png"));
