...
import motordevelopment.motorclient.gui.widgets.WVerticalSeparator;
import motordevelopment.motorclient.utils.render.color.Color;

public class WMotorVerticalSeparator extends WVerticalSeparator implements MotorWidget {
    @Override
