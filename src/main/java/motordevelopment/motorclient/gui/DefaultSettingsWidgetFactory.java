...
import motordevelopment.motorclient.gui.screens.settings.*;
import motordevelopment.motorclient.gui.themes.motor.widgets.WMotorLabel;
...
public class DefaultSettingsWidgetFactory extends SettingsWidgetFactory {
    ...
    private static class WSelectedCountLabel extends WMotorLabel {
