...
public abstract class BlockStateMixin extends BlockBehaviour.BlockStateBase {
    public BlockStateMixin(BlockBehaviour block, Reference2ObjectArrayMap<Property<?>, Comparable<?>> propertyMap, MapCodec<BlockState> mapCodec) {
        super(block, propertyMap, mapCodec);
    }

    @Override
    public InteractionResult onUse(Level world, Player player, BlockHitResult hit) {
