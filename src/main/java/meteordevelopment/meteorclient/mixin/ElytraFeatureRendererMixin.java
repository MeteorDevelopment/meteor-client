...
public abstract class ElytraFeatureRendererMixin<S extends BipedEntityRenderState, M extends EntityModel<S>> extends FeatureRenderer<S, M> {
    ...
    private Identifier modifyCapeTexture(Identifier original, MatrixStack matrices, EntityRenderCommandQueue entityRenderCommandQueue, int i, S state, float f, float g) {
