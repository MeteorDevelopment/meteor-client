...
public abstract class PlayerListHudMixin {
    ...
    private void modifyHeight(CallbackInfo ci, @Local(index = 11) LocalIntRef o, @Local(index = 12) LocalIntRef p) {
        BetterTab module = Modules.get().get(BetterTab.class);
    ...
    private void onRenderLatencyIcon(GuiGraphicsExtractor context, int width, int x, int y, PlayerInfo entry, CallbackInfo ci) {
        BetterTab betterTab = Modules.get().get(BetterTab.class);
