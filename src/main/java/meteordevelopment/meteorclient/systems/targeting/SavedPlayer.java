...
public class SavedPlayer implements ISerializable<SavedPlayer>, Comparable<SavedPlayer> {
    public volatile String name;
    private volatile @Nullable UUID id;
    private volatile @Nullable PlayerHeadTexture headTexture;
    private volatile boolean updating;

    public SavedPlayer(String name, @Nullable UUID id) {
        this.name = name;
        this.id = id;
        this.headTexture = null;
    }

    public SavedPlayer(PlayerEntity player) {
    ...
    @Override
    public SavedPlayer fromTag(NbtCompound tag) {
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        SavedPlayer player = (SavedPlayer) o;
    ...
    @Override
    public int compareTo(@NotNull SavedPlayer player) {
        return name.compareToIgnoreCase(player.name);
    }
