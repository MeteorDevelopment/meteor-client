...
public class AutoAnvil extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (placeButton.get()) {
            FindItemResult floorBlock = InvUtils.findInHotbar(itemStack -> BasePressurePlateBlock.getBlockFromItem(itemStack.getItem()) instanceof BasePressurePlateBlock || BasePressurePlateBlock.getBlockFromItem(itemStack.getItem()) instanceof ButtonBlock);
        ...
        if (timer >= delay.get()) {
            ...
            FindItemResult anvil = InvUtils.findInHotbar(itemStack -> BasePressurePlateBlock.getBlockFromItem(itemStack.getItem()) instanceof AnvilBlock);
