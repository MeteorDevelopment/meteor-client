...
public class AntiBed extends Module {
    ...
    private void sendMinePackets(BlockPos blockPos) {
        ((ClientPlayerInteractionManagerAccessor) mc.gameMode).meteor$startPrediction(mc.level, (sequence) -> new ServerboundPlayerActionPacket(ServerboundPlayerActionPacket.Action.START_DESTROY_BLOCK, blockPos, Direction.UP, sequence));
        ((ClientPlayerInteractionManagerAccessor) mc.gameMode).meteor$startPrediction(mc.level, (sequence) -> new ServerboundPlayerActionPacket(ServerboundPlayerActionPacket.Action.STOP_DESTROY_BLOCK, blockPos, Direction.UP, sequence));
    }
