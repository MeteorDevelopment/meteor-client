...
public class StashFinder extends Module {
    ...
    private File getJsonFile() {
        return new File(new File(new File(MeteorClient.FOLDER, "stashes"), Utils.getCompatibleWorldName()), "stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(MeteorClient.FOLDER, "stashes"), Utils.getCompatibleWorldName()), "stashes.csv");
    }
