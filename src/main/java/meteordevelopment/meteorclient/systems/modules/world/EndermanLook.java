...
public class EndermanLook extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        for (Entity entity : mc.world.getEntities()) {
            if (!(entity instanceof EnderMan enderman) || !enderman.isAlive() || !mc.player.canSee(enderman)) continue;
    ...
    /**
     * @see EndermanEntity#isPlayerStaring(Player)
     */
    private boolean angleCheck(EnderMan entity) {
        Vec3 vec3d = mc.player.getRotationVec(1.0F).normalize();
        Vec3 vec3d2 = new Vec3d(entity.getX() - mc.player.getX(), entity.getEyeY() - mc.player.getEyeY(), entity.getZ() - mc.player.getZ());
