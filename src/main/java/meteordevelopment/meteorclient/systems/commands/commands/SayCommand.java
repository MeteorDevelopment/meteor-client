...
public class SayCommand extends Command {
    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(argument("message", StringArgumentType.greedyString()).executes(context -> {
            ...
            if (script != null) {
                String content = MeteorStarscript.run(script);
                ...
                if (content != null) {
                    ...
                    MessageSignatureData messageSignatureData = ((ClientPlayNetworkHandlerAccessor) handler).getMessagePacker().pack(new MessageBody(content, instant, l, lastSeenMessages.lastSeen()));
