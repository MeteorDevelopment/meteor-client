...
import meteordevelopment.meteorclient.mixin.RenderSetupAccessor;
...
public class WireframeEntityRenderer {
    ...
    private static class MyVertexConsumerProvider extends MultiBufferSource.BufferSource {
        ...
        public VertexConsumer getBuffer(RenderType layer) {
            if (((RenderSetupAccessor) (Object) ((RenderLayerAccessor) layer).getRenderSetup()).meteor$getOutputTarget() == OutputTarget.ITEM_ENTITY_TARGET) {
