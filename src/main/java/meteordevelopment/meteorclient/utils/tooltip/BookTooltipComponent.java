...
public class BookTooltipComponent implements ClientTooltipComponent, MeteorTooltipData {
    ...
    private final FormattedCharSequence page;

    public BookTooltipComponent(FormattedCharSequence page) {
        this.page = page;
    }
    ...
    public void drawItems(Font textRenderer, int x, int y, int width, int height, GuiGraphics context) {
        ...
        int offset = 0;
        for (FormattedCharSequence line : textRenderer.wrapLines(page, 112)) {
