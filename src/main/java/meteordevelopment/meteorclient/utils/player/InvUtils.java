...
public class InvUtils {
    ...
    public static void dropHand() {
        if (!mc.player.containerMenu.getCarried().isEmpty()) mc.gameMode.handleContainerInput(mc.player.containerMenu.containerId, AbstractContainerMenu.SLOT_CLICKED_OUTSIDE, 0, ContainerInput.PICKUP, mc.player);
    }
