 ...
 * <p>
 * Getting the pose calls {@link meteordevelopment.meteorclient.mixin.EntityMixin#modifyGetPose(net.minecraft.entity.Pose)},
 * which calls {@link PlayerEntity#canChangeIntoPose(net.minecraft.entity.Pose)}, which
