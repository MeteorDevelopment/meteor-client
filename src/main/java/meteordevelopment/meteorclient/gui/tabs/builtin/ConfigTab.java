    ...
    public static class ConfigScreen extends WindowTabScreen {
        ...
        public ConfigScreen(GuiTheme theme, Tab tab) {
            ...
            onClosed(() -> {
                ...
                if (prefix.isBlank()) YesNoPrompt.create(theme, this.parent)
                    ...
                    .show();
                else if (prefix.equals("/")) YesNoPrompt.create(theme, this.parent)
                    ...
                    .show();
                else if (prefix.length() > 7) YesNoPrompt.create(theme, this.parent)
